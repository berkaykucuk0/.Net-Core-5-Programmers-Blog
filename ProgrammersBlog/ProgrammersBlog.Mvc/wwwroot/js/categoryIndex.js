                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (categoryListDto.ResultStatus === 0) {
                                ...
                                $.each(categoryListDto.Category.$values,
                                    function (index, category) {
                                        const newTableRow = dataTable.row.add([
                                            ...
                                            category.Note,
                                            category.CreateDate.toString().substring(0, 10),
                                            category.CreatedByName,
                                            category.ModifiedDate.substring(0, 10),
    ...
    $(document).on('click',
        ...
        function (event) {
            ...
            Swal.fire({
                ...
                text: `${categoryName} adlı kullanıcı silinicektir!`,
                icon: 'warning',
